...
// Load helpers.
import ChartMap from './modules/ChartMap2.jsx';
  ...
  return (
    <div className="app" ref={appRef}>
      <div className="title_container">
        ...
        <div className="title">
          <h3>Commodity dependence by dominant export product group</h3>
          <h4>
            <span>Per country, percentage</span>
            , 2021–2023
          </h4>
        </div>
      </div>
      {data !== false && <ChartMap values={data} ref={mapRef} type="all" />}
    </div>
  );
}
